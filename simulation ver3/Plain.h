...
void DrawGapPlain(int i, int j, int k) {
	...
	//glColor3d(1, 0, 0);
	if (p[i][j][k] == 1.5) glColor3d(0.2, 0.0, 0.0);//–Ø”Â‚Å‹²‚ñ‚¾‚Æ‚±‚ë
